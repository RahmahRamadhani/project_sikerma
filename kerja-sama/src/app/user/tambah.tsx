      ...
      <Modal
        ...
        children={
          <form onSubmit={handleSubmit}>
            <h2 className="text-xl text-center font-bold mb-4">Tambah Data User</h2>
            ...
            <label htmlFor="role" className="block text-sm mt-2 font-medium text-gray-700">Role</label><select
              id="role"
              value={role}
              onChange={(e) => setRole(e.target.value)}
              className="mt-2 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 border-[1.5px] px-2 py-3 outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter"
            >
              {/* Definisikan opsi role sesuai enum di Prisma */}
